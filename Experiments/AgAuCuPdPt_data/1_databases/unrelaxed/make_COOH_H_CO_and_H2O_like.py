...
def add_COOH_H(slab, site_idx=0):
	...
	COOH.positions += site_position + [0.2, 0.2, 0.]
	COOH.positions[:, 2] += height
	
	# Set *H on surface
	H = deepcopy(H_orig)
	H.positions += site_position + [2.1, 1.3, 0.]
...
with connect('single_element_COOH_H_CO_and_H2O_like.db') as db_ads,\
